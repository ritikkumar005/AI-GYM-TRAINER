...
cap = cv2.VideoCapture("C:\\Users\\ritik\\Desktop\\project\\AI GYM TRAINER\\dips.mp4")
...
while True:
    ...
    if len(lmList) != 0:
        ...
        per = np.interp(leftArm_angle, (185, 240), (0, 100))
        bar = np.interp(leftArm_angle, (180, 240), (650, 100))
